...
trait2GWASStr = c("HDL","High-density lipoprotein","high density")
expPath="/project/voight_datasets/GWAS/01_alzD/AD_sumstats_Jansenetal.txt"
outPath="/project/voight_GWAS/wbone/neuro_degenerative_and_cardiometabolic_Bivariate_Scans/HDL_AD_bivar_scan_re_meta/HDL_remeta_data_with_MAF.txt"
trait1_A1col = "A1"
trait1_A2col = "A2"
trait2_A1col = "A1"
trait2_A2col = "A2"
...
out_dat = read_outcome_data("/project/voight_GWAS/wbone/neuro_degenerative_and_cardiometabolic_Bivariate_Scans/HDL_AD_bivar_scan_re_meta/HDL_remeta_data_with_MAF.txt",sep="\t",snp_col="SNP",effect_allele_col="A1",other_allele_col="A2",eaf_col="MAF",se_col="SE",pval_col=trait2_Pcol,beta_col="Beta")
