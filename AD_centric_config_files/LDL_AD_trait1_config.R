...
trait2GWASStr = c("LDL","Low-density lipoprotein","low density")
expPath="/project/voight_datasets/GWAS/01_alzD/AD_sumstats_Jansenetal.txt"
outPath="/project/voight_GWAS/wbone/neuro_degenerative_and_cardiometabolic_Bivariate_Scans/LDL_AD_bivar_scan_re_meta/LDL_remeta_data_with_MAF.txt"
trait1_A1col = "A1"
trait1_A2col = "A2"
trait2_A1col = "A1"
trait2_A2col = "A2"
...
out_dat = read_outcome_data("/project/voight_GWAS/wbone/neuro_degenerative_and_cardiometabolic_Bivariate_Scans/LDL_AD_bivar_scan_re_meta/LDL_remeta_data_with_MAF.txt",sep="\t",snp_col="SNP",effect_allele_col="A1",other_allele_col="A2",eaf_col="MAF",se_col="SE",pval_col=trait2_Pcol,beta_col="Beta")
