...
trait2_Ncol = "N"
trait1_MAFcol = "MAF"
trait2_MAFcol = "Freq_Tested_Allele_in_HRS"
...
#AllIndSigSNPs = read.table(file="/project/voight_GWAS/wbone/neuro_degenerative_and_cardiometabolic_Bivariate_Scans/DBP_AD_bivar_scan_Sept_2019/AllSigSNPs_ADDBP_r2Indepdent.txt",sep="\t", header=TRUE)
